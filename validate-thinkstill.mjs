...
const ritualsPayload = read("thinkstill-rituals.v18.1.json");
const routingPayload = read("thinkstill-routing.v18.1.json");
const safetyPayload = read("thinkstill-safety.v18.1.json");
const firstPayload = read("thinkstill-first-session.v18.1.json");

const rituals = ritualsPayload.rituals;
const routing = routingPayload.routing;

assert(manifest.version === "18.1.0", "Manifest version must be 18.1.0");
...
console.log("✓ ThinkStill v18.1 validation passed");
