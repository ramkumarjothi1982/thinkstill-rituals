/**
 * ThinkStill v36 FINAL loader
 * Consumer ritual order:
 * Title → Goal → numbered ritual → one-line Win → Formula Flow → Safety
 *
 * Hook and Game Move remain internal metadata and are not included in
 * renderer-facing composite fields.
 */
export const THINKSTILL_RAW_BASE =
  "https://raw.githubusercontent.com/ramkumarjothi1982/thinkstill-rituals/refs/heads/main";

const SEEN_KEY = "thinkstill_seen_ritual_ids_v36";
