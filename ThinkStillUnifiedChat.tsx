// ===================== PART 1/5 =====================
// ThinkStill — Unified Chat (v38.12.0 GROWTH RELEASE — VIRAL REVEALS + ADAPTIVE RESET DNA)
...
function buildShareUrl(ritualId: string, shareBaseUrl = "") {
    if (typeof window === "undefined") return ""
    try {
        const base = String(shareBaseUrl || "").trim()
...
export default function ThinkStillUnifiedChat(props: any) {
    ...
    const rateCurrentShift = (rating: number) => {
        ...
        recordShiftRating(currentSig, currentMeta, rating)
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    style={{
                                                                        ...
                                                                        borderRadius: 12,
                                                                        border: selected
                                                                            ? "1px solid rgba(154,237,255,.34)"
                                                                            : "1px solid rgba(159,226,246,.10)",
                                                                        background: selected
                                                                            ? "linear-gradient(180deg, rgba(118,229,255,.15), rgba(174,122,255,.08))"
