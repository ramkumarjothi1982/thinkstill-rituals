// ===================== PART 1/5 =====================
// ThinkStill — Unified Chat (v37.2 EASY INTEGRATED ZERO-REPEAT FINAL)
...
function ritualTextDefault(r: BubbleRitual) {
    // v37.2: Title → Goal → numbered ritual → one Win → Formula Flow → Safety.
    // Hook/Game Move stay internal; power moves are already blended naturally into the steps.
...
function parsePremiumRitual(text: string): ParsedRitual {
    ...
    for (; i < raw.length; i++) {
        ...
        if (/^(POWER[- ]?UP|POTENCY STACK)$/i.test(upper)) {
            section = "powerup"
            continue
        }
