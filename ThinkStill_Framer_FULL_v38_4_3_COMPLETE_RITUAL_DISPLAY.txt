...
function buildDisplayTitleless(opts: {
    ...
    const main = sanitizeTextForDisplayStrict(rawText, true)
    ...
    // v36.2 clean consumer hierarchy:
    // Title → Goal → numbered ritual → Finish → Win → Formula Flow → Safety.
    // No separate comfort/promise card is injected above the ritual title.
