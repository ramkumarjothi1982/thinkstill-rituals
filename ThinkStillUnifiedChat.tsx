// ===================== PART 1/5 =====================
// ThinkStill — Unified Chat (v36 FINAL CLEAN CONSUMER RENDERER)
...
function ritualTextDefault(r: BubbleRitual) {
    // v36: Title → Goal → numbered ritual → one Win → Formula Flow → Safety.
    // Hook/Game Move stay internal; potency is already integrated into the steps.
