// ===================== PART 1/5 =====================
// ThinkStill — Unified Chat (WEIGHTED SUBPATTERN ROUTER v17.0)
...
function sanitizeTextForDisplayStrict(text: string) {
    ...
    const noDiag = removeDiagnosticLines(cleaned)
    const paragraphed = paragraphizeIfNeeded(noDiag)
...
function buildDisplayTitleless(opts: {
    ...
    const comfort = comfortPrefixVar(
        bubbleKey,
        comfortLevel,
        msgSeed,
        challengeFromUser
    ...
    const comeback = returnCue(bubbleKey)
        ...
        try {
            ...
            if (!out) {
                const fallbackText = [
                    ...
                    `Return: If you need another pass, type: “${String(
                        preferredKey
                    ).toLowerCase()}”.`,
                ]
                    .filter(Boolean)
            ...
            setCurrentText(`${msg}\n\nTip: manifest must be a RAW GitHub URL.`)
