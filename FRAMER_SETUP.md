...
- v2000 semantic competitive routing with dedicated urge/substance intent.
...
## v38.12 sharing setup

Set the Framer **Share Base URL** property to the published ThinkStill page that contains this component. The component appends `?try=TS-xxx` to this URL so recipients can open the exact shared ritual. Leave it blank only during local/Framer preview testing.
